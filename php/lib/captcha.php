  ...
  */
  namespace lorrx
  {
    class captcha
    {
      ...
      public function __construct($length, $fontSize, $h=50, $w=150, $PN=500, $LN=5, $fontPath="", $captchaPath="", $MarginTop=75, $MarginLeft=50, $clearCacheOnRender=false)
      {
      ...
      public function getCaptcha()
      {
        ...
        return $this->captchaPath.$this->secureWord.".png";
      }
      ...
      private function renderCaptcha()
      {
        ...
        imagepng($this->image, $this->captchaPath.$this->secureWord.".png");
      }
      ...
      public function clearCache()
      {
        if ($handle = opendir($this->captchaPath)) 
        {
          ...
          {
            if (($entry != ".") AND ($entry != "..") AND ($entry != $this->secureWord.".png")) 
            {
